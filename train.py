...
def get_args():
    ...
    parser.add_argument('--algorithm', type=str, default="MMD")
    ...
    parser.add_argument('--data_file', type=str, default='',
                        help='root_dir')
    parser.add_argument('--dataset', type=str, default='ZXJ_GD')
    parser.add_argument('--data_dir', type=str, default='D:\python_workfile\TL-comparsion\DeepDG\database\office31\office31\\', help='data dir')
